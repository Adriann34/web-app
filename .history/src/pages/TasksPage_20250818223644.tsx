              ...
              {(showCompleted ? completedTasks : pendingTasks).map((task, index) => (
                ...
                >
                  ...
                  <button
                    ...
                    className="absolute top-4 right-4 opacity-0 group-hover:opacity-100 transition-opacity bg-white bg-opacity-70 hover:bg-opacity-90 rounded-full w-8 h-8 flex items-center justify-center text-sm z-10"
                  >
