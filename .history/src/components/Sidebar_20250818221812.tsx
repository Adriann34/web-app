import React, { useState, useMemo, JSX, createContext, useContext } from 'react';
...
function Sidebar(): JSX.Element {
  ...
  return (
    <>
      {/* Sidebar */}
      <div className={`${sidebarWidth} bg-white dark:bg-gray-900 h-screen fixed top-0 left-0 shadow-xl border-r border-gray-200 dark:border-gray-700 flex flex-col transition-all duration-300 z-50 overflow-y-auto`}>
        {/* Header with Profile */}
      ...
      {/* Content Spacer - This pushes the main content to the right */}
